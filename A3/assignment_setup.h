...
inline void assignment_setup(int argc, char **argv, Eigen::VectorXd &q, Eigen::VectorXd &qdot) {
    ...
    //load geometric data 
    igl::readMESH("../../../../A3/data/coarser_bunny.mesh",V,T, F);
    igl::readOBJ("../../../../A3/data/bunny_skin.obj", V_skin, F_skin);

    if(argc > 1) {
        if(strcmp(argv[1], "arma") == 0) {
            read_tetgen(V,T, "../../../../A3/data/arma_6.node", "../../../../A3/data/arma_6.ele");
            igl::readOBJ("../../../../A3/data/armadillo.obj", V_skin, F_skin);
